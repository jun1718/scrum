...
## 설명
성과 보고 목록을 조회한다. 응답에 reportTag.aiSummaryContent가 포함된다.
    ...
    "reportTags": [
      {
        ...
        "workRatio": 55.0,
        "aiSummaryContent": "프로젝트A에서 백엔드 핵심 기능(JWT 인증, API 설계, 배치 처리)을 주도적으로 개발하고, 코드 리뷰를 통해 팀 전체 코드 품질 향상에 기여함. 특히 보고서 자동 생성 파이프라인 구축으로 수작업 공수를 80% 절감하는 성과를 달성함."
      }
    ]
  }
]
