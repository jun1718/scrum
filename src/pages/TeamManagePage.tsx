    ...
    return (
      <div className="bg-gray-50 min-h-full">
        ...
        <div className="p-6 flex flex-col items-center justify-center min-h-[40vh] text-center">
          <p className="text-gray-500 mb-4">속한 팀을 먼저 지정해주세요. (1인 1팀)</p>
          <Link
            to="/team/assign"
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-xs text-gray-500 mb-2">주간 태그 (추가/수정/삭제)</p>
              {weeklyTags.map((t) => (
            ...
            <div>
              <p className="text-xs text-gray-500 mb-2">월간 태그 (추가/수정/삭제)</p>
              {monthlyTags.map((t) => (
                <div key={t.tagId} className="flex gap-2 items-center mb-2">
                  <input
                    type="text"
